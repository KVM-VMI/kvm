...
enum {
	...
	KVMI_VCPU_GET_EPT_VIEW       = 24,
	KVMI_VCPU_SET_EPT_VIEW       = 25,
	KVMI_VCPU_CONTROL_EPT_VIEW   = 26,
	KVMI_VCPU_SET_VE_INFO        = 27,
	KVMI_VCPU_DISABLE_VE         = 28,

	KVMI_VM_SET_PAGE_SVE = 29,

	KVMI_VM_GET_MAP_TOKEN = 30,
	KVMI_VM_CONTROL_CMD_RESPONSE = 31,
	KVMI_VM_CONTROL_SPP = 32,
	KVMI_VM_SET_PAGE_WRITE_BITMAP = 33,
